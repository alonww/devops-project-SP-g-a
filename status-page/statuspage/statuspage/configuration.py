...
DATABASE = {
    ...
    'USER': 'alon',               # PostgreSQL username
    'PASSWORD': 'galandalon',           # PostgreSQL password
    'HOST': 'alonandgal.cx248m4we6k7.us-east-1.rds.amazonaws.com',      # Database server
...
SECRET_KEY = 'Z4afjCK7i9-g$PtrnziqP601xl@JgAvsYAG@OLoTIVJpj0DgIL'
